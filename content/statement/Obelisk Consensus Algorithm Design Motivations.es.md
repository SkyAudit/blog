...
>>El gráfico de conectividad para relaciones de confianza, se supone que es un gráfico aleatorio completamente conectado. Unos cuantos nodos (miembros de la comunidad confiables, intercambios, sitios web, organizaciones) tendrán más relaciones de confianza y eso ayuda un poco al tiempo de convergencia para el consenso de bloques. Reduce un poco el diámetro de la red. Algunos nodos serán utilizados para verificar consenso (tu escoges un montón de intercambios o diferentes llaves públicas), esos nodos no afectan decisiones de consenso, pero son "oráculos de consenso" para chequear si tu nodo ha convergido con la red.       
